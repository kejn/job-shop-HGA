...
\supervisor{dr hab. Wojciech Bożejko Prof. PWr, W4/K-8}
...
% %
% \newpage
% \addcontentsline{toc}{chapter}{Cel i zakres projektu}
% \chapter*{Cel i zakres projektu}
% %
% %
% %
% \newpage
% \addcontentsline{toc}{chapter}{Zakres pracy}
...
\lstinputlisting[language=C++]{html_lib/ContentHTML.h}
%
\section{Klasa \texttt{TextContentHTML.h}}
\lstinputlisting[language=C++]{html_lib/TextContentHTML.h}
\lstinputlisting[language=C++]{html_lib/TextContentHTML.cpp}
%
\section{Klasa \texttt{TagContentHTML}}
\lstinputlisting[language=C++]{html_lib/TagContentHTML.h}
\lstinputlisting[language=C++]{html_lib/TagContentHTML.cpp}
%
\section{Klasa \texttt{PageHTML}}
\lstinputlisting[language=C++]{html_lib/PageHTML.h}
\lstinputlisting[language=C++]{html_lib/PageHTML.cpp}
%
\section{Style CSS}
\lstinputlisting{html_lib/gantt_styles.css}
\section{JavaScript}
\lstinputlisting{html_lib/hover_functions.js}
\end{appendices}
% BIBLIOGRAFIA
\newpage
%\clearpage        % ALBO
